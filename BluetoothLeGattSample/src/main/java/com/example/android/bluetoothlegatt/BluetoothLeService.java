...
public class BluetoothLeService extends Service {
    ...
    private static final UUID UUID_LOCK8_NOTIFICATION = UUID
            .fromString(SampleGattAttributes.LOCK8_NOTIFICATION_CHARACTERISTIC);
    ;
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt,
                BluetoothGattCharacteristic characteristic) {
            broadcastUpdate(ACTION_DATA_AVAILABLE, characteristic);
            // Toast.makeText(BluetoothLeService.this, "characteristic changed in service", Toast.LENGTH_SHORT).show();
    ...
    private void broadcastUpdate(final String action,
        ...
        /*
        //dwf read the value here
        if (UUID_LOCK8_NOTIFICATION.equals(characteristic.getUuid())) {
            int flag = characteristic.getProperties();
            int format = -1;
            if ((flag & 0x01) != 0) {
                format = BluetoothGattCharacteristic.FORMAT_UINT16;
    ...
    public void setCharacteristicNotification(BluetoothGattCharacteristic characteristic,
        ...
        } else if (UUID_LOCK8_NOTIFICATION.equals(characteristic.getUuid())) {
            BluetoothGattDescriptor descriptor = characteristic.getDescriptor(
                    UUID.fromString(SampleGattAttributes.CLIENT_CHARACTERISTIC_CONFIG));
            descriptor.setValue(BluetoothGattDescriptor.ENABLE_NOTIFICATION_VALUE);
